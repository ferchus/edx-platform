...
class SubsectionGradeFactoryTest(GradeTestBase):
    ...
    def test_subsection_grade_feature_gating(self, feature_flag, course_setting):
        ...
        # both set to True.
        with patch(
            'lms.djangoapps.grades.models.PersistentSubsectionGrade.read_grades_for_user_in_course'
...
class SubsectionGradeTest(GradeTestBase):
    ...
    def test_save_and_load(self):
        ...
        input_grade.create_model(self.request.user, self.sequence, self.course)
